...
If you want to load your expression data, please refer to the `r Biocpkg("iSEE", vignette="pcaExplorer.html", label="User Guide")`, which contains detailed information on the formats your data have to respect.
